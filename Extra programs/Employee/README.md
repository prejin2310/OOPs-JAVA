## :question: Write a program that describes a class Employee. It should have instance variable to record id,name,phone number,Designation,Department,Create an Employee object.
